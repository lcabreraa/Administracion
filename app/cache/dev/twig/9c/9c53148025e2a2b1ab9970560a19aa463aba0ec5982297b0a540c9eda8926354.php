...
class __TwigTemplate_eed6d94ed73dd8ad7bcafa687f0d9b6e3e00f108802bc161d242ab787d2de1d0 extends Twig_Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        ";
            ...
            // line 31
            echo "        ";
            $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "@WebProfiler/Collector/logger.html.twig", 31)->display(array_merge($context, ["link" => ($context["profiler_url"] ?? $this->getContext($context, "profiler_url"))]));
            // line 32
            echo "    ";
        }
    }
...
";
    ...
    public function getdisplay_message($__log_index__ = null, $__log__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 93
            echo "    ";
            if ((twig_constant("Symfony\\Component\\HttpKernel\\Debug\\ErrorHandler::TYPE_DEPRECATION") == (($this->getAttribute($this->getAttribute(($context["log"] ?? null), "context", [], "any", false, true), "type", [], "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["log"] ?? null), "context", [], "any", false, true), "type", []), 0)) : (0)))) {
                // line 94
                echo "        DEPRECATION -  ";
...
{% macro display_message(log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/home/thinkpad/symfony/Administracion/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
