...
class __TwigTemplate_4bc05e7bd6606381ff083d45c9970f99c5e75db8e87b705245e915c7b6ce68bc extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 40
            echo "    ";
            $this->loadTemplate("TwigBundle:Exception:traces.html.twig", "TwigBundle:Exception:exception.html.twig", 40)->display(["exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? $this->getContext($context, "previous_count"))]);
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 66
            $this->loadTemplate("TwigBundle:Exception:logs.html.twig", "TwigBundle:Exception:exception.html.twig", 66)->display(["logs" => $this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "logs", [])]);
            // line 67
            echo "        </div>
    </div>
";
...
";
        // line 91
        $this->loadTemplate("TwigBundle:Exception:traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 91)->display(["exception" => ($context["exception"] ?? $this->getContext($context, "exception"))]);
        // line 92
        echo "
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "/home/thinkpad/symfony/Administracion/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
